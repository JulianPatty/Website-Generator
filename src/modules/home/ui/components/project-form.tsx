...
const createProject = useMutation(trpc.projects.create.mutationOptions({
    ...
    return (
        <Form {...form}>
            ...
            className={cn ("relative border p-1 pt-1 rounded-xl bg-sidebar dark:bg-sidebar transition-all",
                isFocused && "shadow-xs",
            ...
            />
            <div className="flex gap-x-3 items-end justify-between pt-4">
            ...
            <div className="flex-wrap justify-center gap-1 hidden md:flex max-w-4xl px-4">
